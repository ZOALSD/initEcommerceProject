...
{!! Form::select('category_id',App\Models\Category::pluck('category_name','id'), $products->category_id ,['class'=>'form-control select2','placeholder'=>trans('admin.category_id')]) !!}
		</div>
</div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::textarea('description', $products->description ,['class'=>'form-control','placeholder'=>trans('admin.description')]) !!}
    </div>
</div>
